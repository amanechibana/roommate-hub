...
`021_household_reliability.sql`, and `022_household_life.sql`.
...
Migration 014 lets a to-do or shopping item's category be “Personal”. Apply it
before deploying personal entries; without it the category is refused. Verify
it with `supabase/tests/personal-todos.sql` in a disposable database.
